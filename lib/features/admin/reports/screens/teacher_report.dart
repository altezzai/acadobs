        ...
        child: Padding(
          ...
          child: Column(
            children: [
              ...
              _buildTeacherReportByNameAndDate(context: context),
            ],
          ),
        ),
      ),
                      ...
                      child: DataTable(
                          ...
                          border: TableBorder(
                            borderRadius: BorderRadius.circular(
                                26), // Still needed for bottom corners
                          ),
                          columnSpacing: 30,
                          columns: [
                            DataColumn(
                          ...
                          rows: value.filteredteacherreports.map((teacher) {
                            return DataRow(
                              cells: [
                                DataCell(Text(teacher.teacherId.toString())),
                                DataCell(Text(capitalizeFirstLetter(
                                    teacher.fullName ?? ""))),
                                DataCell(Center(
                                  child: Text(teacher.attendanceRecordedCount
                                      .toString()),
                                )),
                                DataCell(Center(
                                  child: Text(
                                ...
                                DataCell(Center(
                                  child: Text(
                                      teacher.leaveApprovedCount.toString()),
                                )),
                                DataCell(Center(
                                  child: Text(
                                      teacher.leaveRejectedCount.toString()),
                                )),
                                DataCell(Center(
                                    child:
                                        Text(teacher.totalDuties.toString()))),
                                DataCell(Center(
                                  child:
                                      Text(teacher.completedDuties.toString()),
                                )),
                              ],
                            );
                          }).toList()),
