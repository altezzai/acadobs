                ...
                Column(
                  ...
                  children: [
                      ...
                      children: [
                        Expanded(
                          child: CustomDropdown(
                            ...
                            validator: (value) => FormValidator.validateNotEmpty(value,fieldName: "Year"),
                          ),
                        ),
                        const SizedBox(width: 16),
                        Expanded(
                          child: CustomDropdown(
                            ...
                            validator: (value) => FormValidator.validateNotEmpty(value,fieldName: "Month"),
                          ),
                        ),
                      ],
                    ),
                    ...
                    CustomDatePicker(
                      ...
                      label: 'Payment Date',
                      validator: (value) => FormValidator.validateNotEmpty(value,fieldName: "Payment Date"),
                    ),
                    const SizedBox(height: 16),
                    CustomTextfield(
                      hintText: 'Amount',
                    ...
                    CustomDropdown(
                      ...
                      items: ['Pending', 'Completed', 'Failed'],
                       validator: (value) => FormValidator.validateNotEmpty(value,fieldName: "Payment Status"),
                    ),
                  ],
                ),
                const SizedBox(height: 16),
